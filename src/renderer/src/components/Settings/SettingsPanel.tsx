    ...
    >
      <div className="bg-claude-panel border border-claude-border rounded-2xl w-[520px] max-h-[80vh] overflow-hidden flex flex-col shadow-2xl">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4 space-y-6">
            ...
            <div className="bg-claude-dark rounded-xl p-4 space-y-3">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  {hooksStatus?.serverRunning ? (
                    ...
                    <span className="flex items-center gap-1.5 text-xs text-claude-muted">
                      <div className="w-1.5 h-1.5 rounded-full bg-claude-muted" />
                      Stopped
                    </span>
                  )}
                </div>
              ...
              <div className="flex items-center justify-between pt-2 border-t border-claude-border">
                <div>
                  ...
                  <div className="text-xs text-claude-muted mt-0.5">Installed in ~/.claude/settings.json</div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  {hooksLoading ? (
                    ...
                    <button
                      ...
                      className="text-xs text-red-400 hover:text-red-300 px-2 py-1 rounded border border-red-800/50 hover:border-red-700/50"
                    >
                      Remove
                    </button>
                  ) : (
                    <button
                      ...
                      className="text-xs text-claude-orange hover:opacity-80 px-2 py-1 rounded border border-claude-orange/50"
                    >
                      Install
                    </button>
                  )}
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                >
                  ...
                  />
                  <span
                    className={`flex-1 font-mono truncate ${local.projectsRootDir ? 'text-claude-text' : 'text-claude-muted'}`}
                  >
          ...
          <section>
            <h3 className="text-xs font-semibold text-claude-muted uppercase tracking-wider mb-3">UI Preferences</h3>
